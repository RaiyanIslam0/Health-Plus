...
import { FaAppleAlt, FaChild } from "react-icons/fa";
...
const LinkItems = [
  ...
  { name: "Exercises", icon: FaChild, title: "/exercises" },
  { name: "Recipes", icon: FaAppleAlt, title: "/recipes" },
  // { name: "Dash", icon: FiHome, title: "/dash" },
